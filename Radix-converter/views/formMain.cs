...
/* ================================= ĐỔI TỪ HEX SANG OCT ===================================== */
    ...
    private void button13_Click(object sender, EventArgs e)
        {
            MessageBox.Show("Kĩ thuật lập trình\rĐề tài: Chuyển đổi cơ số\rDo Nhóm 3 thực hiện\rGVHD: Nguyễn Thiên Bảo\r", "Thông tin chương trình", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
